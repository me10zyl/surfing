...
import com.yilnz.surfing.core.proxy.AutoProxyProvider;
import com.yilnz.surfing.core.proxy.HttpProxy;

import java.util.Arrays;

public class AutoProxyProviderTest {
    public static void main(String[] args) {
        ...
        SurfSpider.create().setRequests(Arrays.asList(request, request2)).setProxyProvider(new AutoProxyProvider(Arrays.asList(proxies))).setProcessor(new SurfPageProcessor() {
            @Override
